...
{{/*
Claim name for config
 */}}
{{- define "jellyfin.claims.config" -}}
...
{{/* 
Claim name for movies
*/}}
{{- define "jellyfin.claims.movies" -}}
{{- if .Values.persistence.movies.claimName -}}
